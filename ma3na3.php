  <?php
ob_start();
define('API_KEY','5406342880:AAEBxEEoOuTCtzFEtIHqeUPj7kOXEVWnpCI');
$admin = 5372193406;
...
mkdir("geme");
//======================================================//
$urls="https://github.com/SiriamUsic/";//رابط استضافه
//»»»»»»»»»»»»»»»»»»
...
file_get_contents("https://api.telegram.org/bot$text/sendMessage?chat_id=$chat_id&text=شكرا لاستخدامك سورس بوليس ❤");
...
bot('sendMessage',['chat_id'=>$chat_id,'text'=>"⌔ التوكن خطأ ارسل توكن صالح",'reply_to_message_id'=>$message->message_id,'reply_markup'=>json_encode([
...
2-ارسل الامر /newbot
3- ارسل اسم للبوت كمثال : 𝐏𝐎𝐋𝐈𝐂𝐄 
4- ارسل معرف للبوت شرط بالنهايه bot
 كمثال لمعرف البوت : @BC_LEbot
